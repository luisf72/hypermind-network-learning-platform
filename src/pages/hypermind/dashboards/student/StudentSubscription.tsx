...
const USER_KARMA = 1840
const USER_TOKENS = 2340
const USER_CREDITS = 180
...
const INVOICES = [
  { id: 'INV-2026-004', date: 'May 4, 2026', plan: 'Pro Annual', amount: '$180.00' },
  { id: 'INV-2025-019', date: 'Mar 12, 2026', plan: 'Pro Annual', amount: '$180.00' },
  { id: 'INV-2025-011', date: 'Mar 12, 2025', plan: 'Pro Monthly', amount: '$19.00' },
  { id: 'INV-2025-003', date: 'Feb 12, 2025', plan: 'Pro Monthly', amount: '$19.00' },
  { id: 'INV-2025-001', date: 'Jan 12, 2025', plan: 'Free', amount: '$0.00' },
]
...
const PLAN_FEATURES = [
  ...
  'AI study assistant (Synthia)',
  'Community karma boosts ×1.5',
]
    ...
    <StudentShell>
      ...
      <div className="mb-6">
        ...
        <p className="text-[13px] mt-1" style={{ color: 'var(--hm-text-muted)' }}>
          Manage your plan, tokens, credits and karma standing.
        </p>
      </div>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg,#140f28 0%,#1c1535 55%,#0f1120 100%)',
      ...
      >
        <div
          ...
          style={{
            background: `radial-gradient(circle at 90% 10%,${VIOLET}28 0%,transparent 55%)`,
          }}
        />
        <div className="relative flex flex-wrap items-start gap-6">
          <div className="flex-1 min-w-[220px]">
            ...
            <p className="hm-mono text-[12px] mt-1" style={{ color: 'var(--hm-text-dim)' }}>
              $180.00 / year · renews <span style={{ color: 'var(--hm-text)' }}>May 12, 2027</span>
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 shrink-0">
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-[12.5px] font-semibold"
            ...
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-[12.5px] font-medium"
              style={{
            ...
            {!confirmCancel ? (
              ...
              >
                <p className="text-[11px] mb-2" style={{ color: RED }}>
          ...
          >
            {(['monthly', 'yearly'] as const).map((b) => (
              <button
                ...
                style={{
                  background: billing === b ? VIOLET_SOFT : 'transparent',
                  color: billing === b ? VIOLET : 'var(--hm-text-muted)',
                  border: billing === b ? `1px solid ${VIOLET}44` : '1px solid transparent',
                }}
              >
              ...
              >
                {p.highlight && (
                  <span
                    ...
                    style={{ background: p.color, color: 'white', letterSpacing: '0.10em' }}
                  >
                    MOST POPULAR
                  </span>
                )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[12px] mt-1" style={{ color: 'var(--hm-text-muted)' }}>
              Use to unlock premium content &amp; features
            </p>
          </div>
          <button
            type="button"
        ...
        >
          ...
          <div>
            ...
            <p className="text-[12px] mt-1" style={{ color: 'var(--hm-text-muted)' }}>
              Spend on course enrolments &amp; certificates
            </p>
          </div>
          <button
            type="button"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
        ...
        <div
          ...
          style={{ background: 'var(--hm-bg-card)', border: `1px solid ${AMBER}30` }}
        >
          <div
            ...
            <div className="flex flex-col gap-1.5 mb-4">
              {HMN_PACKS.map((pack, i) => (
                <button
                  ...
                  style={{
                    background:
                      selectedHmn === i ? 'rgba(244,178,108,0.10)' : 'var(--hm-bg-card-2)',
                    border: `1px solid ${selectedHmn === i ? `${AMBER}55` : 'var(--hm-border)'}`,
                  }}
                >
                  <span
                    className="flex h-4 w-4 items-center justify-center rounded-full shrink-0"
                    style={{
                      background: selectedHmn === i ? AMBER : 'var(--hm-bg-card)',
                      border: `2px solid ${selectedHmn === i ? AMBER : 'var(--hm-border)'}`,
                    }}
                  >
                    {selectedHmn === i && (
                      <span
                  ...
                  <span
                    ...
                    style={{ color: selectedHmn === i ? AMBER : 'var(--hm-text)' }}
                  >
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <ShieldCheck className="h-4 w-4" style={{ color: VIOLET }} />
          <h2 className="text-[14px] font-semibold" style={{ color: 'var(--hm-text)' }}>
            Karma Levels
          </h2>
          <span className="hm-mono text-[10.5px] ml-1" style={{ color: 'var(--hm-text-dim)' }}>
            · earn by answering questions, reviewing peers &amp; contributing
          </span>
        </div>
